...
from send_digest import (
    SURFACE, SURFACE2, BORDER, TEXT, MUTED, ACCENT, GREEN, RED, YELLOW, ORANGE, CYAN, LIME,
...
def render_trade_radar(ctx):
    ...
    def pl(p, is_get):
        ...
        if is_get and p.get("_tfillpos"):
            ...
            chips += f' <span title="upgrades your thin {_pp} — a position you rank near the bottom of the league" style="color:{LIME};font-size:11px;cursor:help;">({_pp})</span>'
