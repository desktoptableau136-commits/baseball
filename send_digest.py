...
def build_email(snap, override_team=None):
    ...
    if _data_fresh:
        _data_badge = (
            f'<span style="color:{MUTED};font-size:9px;margin-left:10px;vertical-align:middle;">'
        ...
        _data_badge = (
            f'<span style="color:{YELLOW};font-size:9px;font-weight:600;margin-left:10px;vertical-align:middle;">'
