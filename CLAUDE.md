...
- **⚡ and the WIN % are mutually exclusive in the corner** — on a toss-up the ⚡ **replaces** the number (the exact odds don't matter at a coin-flip), otherwise the corner shows the % (a decisive 79% / 9% is worth seeing). The flip arrow (▲▼◆) renders after either.
