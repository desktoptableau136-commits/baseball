...
15b. **Trade Radar** — mutually-beneficial trade ideas with rival teams, each with a **Build in Trade Lab** button *(shown only when candidates exist)*
