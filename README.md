...
A hitter with a **game today** also gets a compact **platoon tag** vs tonight's opposing probable starter: green **▲** = a platoon **edge** (a lefty facing a righty, a righty facing a lefty, or a switch-hitter), muted **▽** = a **reverse-platoon** (same-handed) matchup — hover for the exact hands. Empty when there's no game today, the starter is undecided, or the batter's hand is unknown. (This is the re-placed handedness read, moved here from the busier Today's MLB Games card.)
